#ifndef UASPARAMMANAGER_H
#define UASPARAMMANAGER_H
...
class UASParamManager : public QWidget
{
    Q_OBJECT
public:
    UASParamManager(UASInterface* uas, QWidget *parent = 0);
