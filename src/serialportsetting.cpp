...
SerialPortSetting::SerialPortSetting(LinkInterface* link, QWidget *parent, Qt::WindowFlags flags) : QWidget(parent, flags),
...
void SerialPortSetting::showEvent(QShowEvent* event)
{
    Q_UNUSED(event);
    setupPortList();
...
void SerialPortSetting::hideEvent(QHideEvent* event)
{
    Q_UNUSED(event);
    writeSettings();
    //portCheckTimer->stop();
...
void SerialPortSetting::loadSettings()
{
...
void SerialPortSetting::writeSettings()
{
    // Store settings
    QSettings settings;
    settings.beginGroup("SERIAL_CONFIG_WINDOW");
...
QString SerialPortSetting::getSettingsKey(bool checkExists)
{
    QString key;
    QSettings settings;
    bool found = false;
...
void SerialPortSetting::loadPortSettings()
{
    // Load defaults from settings
    QString tmp;
    int itmp;
...
void SerialPortSetting::writePortSettings()
{
    // Store settings
    QSettings settings;
...
QAction* SerialPortSetting::getAction()
{
    return action;
}

void SerialPortSetting::configureCommunication()
{
...
void SerialPortSetting::setupPortList()
{
    if (!link)
        return;
...
void SerialPortSetting::portError(const QString &err) {
...
void SerialPortSetting::setLinkName(QString name)
{
    Q_UNUSED(name);
    // FIXME
...
void SerialPortSetting::setTimeoutMs(int to)
{
    if (to)  // zero is bad, will hang whole program
        link->setTimeoutMillis(to);
}

void SerialPortSetting::setReconnectDelay(int dly)
{
